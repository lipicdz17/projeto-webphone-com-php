...
<!-- BARRA DE PESQUISA  -->
	...
	<!--imgem carrinho -->
<div class="carrinho"><a href="#"><img src="imagem\carrinho.png"/></a></div>
	
	<!--imgem cadastro usuario -->
<div class="imagemusuario"><a href="cadastro.html"><img src="imagem\cadastro_cliente.png"/></a></div>
<!-- MENU PRINCIPAL  -->
 <ul>
    <li class="menu">
...
<div id="vendidos">
	<p> Celulares Mais Vendidos</p>
</div>
<main class="principal">
<?php
include("conexao.php");
   $sql = "SELECT * FROM produtos WHERE nada = 'a partir de'";
   $result = $conexao->query($sql);

if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
?>
	 <article class="vendido">
	    <a href="#"><img src="imagem/<?php echo $row['img'];?>"/> </a>
	  <div class="inner">
	        <h2> <?php echo $row['marca'];?> </h2> 
			<p><?php echo $row['modelo'];?></p>
			<p> <?php echo $row['nada'];?></p>  
			<a href="compra.php?par=add&id=<?php echo $row['id'];?>">R$ <?php echo number_format($row['valor'], 2, ',', '.');?> </a> 
			</div>
	 </article>
	 <?php
			}

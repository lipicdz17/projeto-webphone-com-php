...
<?php
include("conexao.php");
   $sql = "SELECT * FROM produtos where id = 16";
...
<div id="area">
		...
		<div class="tela">
	<div class="grande">
				<img src="imagem/6splusfrente.png">
				<img src="imagem/6spluslateral.png">
				<img src="imagem/6splusfundo.png">
		</div>
	</div>
	<label for="img1"><img src="imagem/6splusfrente.png"></label>
	<label for="img2"><img src="imagem/6spluslateral.png"></label>
	<label for="img3"><img src="imagem/6splusfundo.png"></label>
</div>

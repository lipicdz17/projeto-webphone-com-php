...
<?php
include("conexao.php");
   $sql = "SELECT * FROM produtos where id = 15";
...
<div id="area">
		...
		<div class="tela">
	<div class="grande">
				<img src="imagem/iphone6frente.png">
				<img src="imagem/iphone6lateral.png">
				<img src="imagem/iphone6fundo.png">
		</div>
	</div>
	<label for="img1"><img src="imagem/iphone6frente.png"></label>
	<label for="img2"><img src="imagem/iphone6lateral.png"></label>
	<label for="img3"><img src="imagem/iphone6fundo.png"></label>
</div>

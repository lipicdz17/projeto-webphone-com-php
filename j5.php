...
<?php
include("conexao.php");
   $sql = "SELECT * FROM produtos where id = 17";
...
<!-- carrossel galaxys6 -->
<div class="s6branco"><h6>Samsung Galaxy J5 Branco + Dual Chip Android 5.0 8GB Câmera 8MP<h6></div>
<!-- CARROSSEL -->
<div id="area">
		...
		<div class="tela">
	<div class="grande">
				<img src="imagem/j5frente.jpg">
				<img src="imagem/j5lateral.jpg">
				<img src="imagem/j5fundo.jpg">
		</div>
	</div>
	<label for="img1"><img src="imagem/j5frente.jpg"></label>
	<label for="img2"><img src="imagem/j5lateral.jpg"></label>
	<label for="img3"><img src="imagem/j5fundo.jpg"></label>
</div>

...
<?php
include("conexao.php");
   $sql = "SELECT * FROM produtos where id = 14";
...
<div id="area">
		...
		<div class="tela">
	<div class="grande">
				<img src="imagem/s7frente.jpg">
				<img src="imagem/s7lateral.png">
				<img src="imagem/s7fundo.png">
		</div>
	</div>
	<label for="img1"><img src="imagem/s7frente.jpg"></label>
	<label for="img2"><img src="imagem/s7lateral.png"></label>
	<label for="img3"><img src="imagem/s7fundo.png"></label>
</div>

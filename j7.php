...
<?php
include("conexao.php");
   $sql = "SELECT * FROM produtos where id = 18";
...
<div id="area">
		...
		<div class="tela">
	<div class="grande">
				<img src="imagem/j7frente.png">
				<img src="imagem/j7lateral.png">
				<img src="imagem/j7fundo.png">
		</div>
	</div>
	<label for="img1"><img src="imagem/j7frente.png"></label>

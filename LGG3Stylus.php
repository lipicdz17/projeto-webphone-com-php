...
<?php
include("conexao.php");
   $sql = "SELECT * FROM produtos where id = 19";
...
<!-- carrossel galaxys6 -->
<div class="s6branco"><h6><?php echo $row['marca'];?><?php echo $row['modelo'];?>  <h6></div>
<!-- CARROSSEL -->
<div id="area">
		...
		<div class="tela">
	<div class="grande">
				<img src="imagem/dt-g3-stylus-frente.jpg">
				<img src="imagem/dt-g3-stylus-lateral.jpg">
				<img src="imagem/dt-g3-stylus-fundo.jpg">
		</div>
	</div>
	<label for="img1"><img src="imagem/dt-g3-stylus-frente.jpg"></label>
	<label for="img2"><img src="imagem/dt-g3-stylus-lateral.jpg"></label>
	<label for="img3"><img src="imagem/dt-g3-stylus-fundo.jpg"></label>
</div>
...
<a href="compra.php?par=add&id=<?php echo $row['id'];?>"><button class="button button3">Comprar</button>
</div>
